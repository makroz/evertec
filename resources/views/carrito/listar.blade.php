                                    ...
                                    <section
                                        ...
                                        <div
                                            ...
                                            <p class="font-semibold text-lg mb-1 text-gray-900 group-hover:text-white">
                                                {{ $product->name }}</p>
                                            <p class="text-gray-700 group-hover:text-white mb-2">{{ $product->descrip }}
                                            </p>
                                            <p class="text-green-500 group-hover:text-white mb-2"> Precio Unitario: USD
                                                {{ $product->price }}
                                                <br> Cantidad: {{ $product->quantity }}
                                            </p>
                                            <p class="text-red-700 group-hover:text-white mb-2"> Tortal a Pagar: USD
                                                {{ $product->amount }}
                                            </p>
                                            <hr>
                                            <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8 text-center"
                                                ...
                                                <button type="submit"
                                                    class="m-4  center bg-red-500 active:bg-blue-700 text-white font-semibold hover:text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline transition transform ease-in-out duration-300 hover:-translate-y-1 hover:scale-110">
                                                    Vaciar el Carrito
                                                </button>
                                            </form>
